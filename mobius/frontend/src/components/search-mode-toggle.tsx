...
export function SearchModeToggle({
  ...
  return (
    <button
      ...
      className={`inline-flex h-7 shrink-0 items-center gap-1.5 rounded-full border px-2 text-[11px] transition-colors ${compact ? 'sm:px-2' : 'px-2.5'}`}
      style={{
    ...
    >
      <span className="font-medium whitespace-nowrap">{isQuick ? '快速搜索' : '深度搜索'}</span>
