    ...
    <>
      <div className="relative">
        ...
        <button
          ...
          disabled={disabled}
          title={expandTitle}
          className={`absolute right-2 inline-flex h-6 items-center gap-1 rounded-lg border px-1.5 text-[10px] transition-colors disabled:hidden hover:bg-[var(--surface-control-hover)] ${compact ? 'top-1.5' : 'top-2'} ${expandButtonClassName}`}
          style={{
