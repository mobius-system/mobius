...
import { buildNormalModeTargetUrl, layoutModeForPath, type LayoutMode } from '../../services/layout-mode'
...
export function LayoutModeSwitch({
  ...
  // 当前模式由路由决定; 切换 = 一次显式路由跳转, 只影响当前页面.
  const layoutMode = layoutModeForPath(location.pathname)
