...
>
> One-line install for Windows (PowerShell 5.1+): `irm https://serve.nutshellai.cn/publish/auto/tutorial/deploy-windows-v4.ps1 | iex`. Install and start Docker Desktop, Git for Windows, and Python 3.10+ first; the script automatically uses `docker.1ms.run` for the base image.
>
